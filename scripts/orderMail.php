<?php
    ...
    header("Location: ../cart.html");                        // Where to redirect
    ...
    $orderInformation = $_POST['items-information'];
    $emailContent = 'New order from: '.$emailFrom.'<br><br>'.$orderInformation;     // Actual email content [message + email signature]
    // -----------------------
    ...
    try {
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'NEW ORDER FROM: '.$emailFrom;
